  ...
  return (
    <div className="h-16 px-4 flex justify-between items-center ">
      <div className="font-bold text-sm flex flex-row justify-between " >
        <span>Hello Admin! <PiHandWaving className="fill-orange-400 h-5 w-5 pb-1 inline" /> </span>
      ...
      <div className="relative">
        ...
        <input
          type="text"
          placeholder="Search"
          className="text-sm h-10 w-[20rem] border border-white rounded-lg pl-9 pr-4"
        />
      </div>
    </div>
  );
